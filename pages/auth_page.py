...
class AuthorizationPage:
    ...
    def check_successful_authorization(self):
        check_successful_authorization = self.wait.until(
            EC.visibility_of_element_located(locator.AUTH_SUCCESS))
    ...
    def logout_user(self):
        logout_user = self.driver.find_element(*locator.LINK_LOGOUT)
        logout_user.click()

    def check_logout(self):
        logout = self.driver.find_element(*locator.BTN_ENTER)
